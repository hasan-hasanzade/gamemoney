...
import PersonageIcon from '../../../public/bonus/man.svg';
import { Tooltip } from 'react-tooltip';

const BonusPaymentPopup = ({ onClose }) => {
  ...
  return (
    <div className={styles.overlay}>
      <div className={styles.bonus} ref={popupRef}>
        <div className={styles.body}>
          ...
          <div className={styles.content}>
            <div className={styles.conditions}>
              ...
              <div className={styles.actions}>
                <div className={styles.actionWrap}>
                  ...
                  <Link href="#" className={styles.subscribed}>
                    1. Подписаться на группу{' '}
                    <VkIcon className={styles.condedIcon} width={26} height={15} />
                  </Link>
                  ...
                  <div className={styles.checked}>
                    <CheckedIcon width={20} height={15} />
                  </div>
                </div>
                <div className={styles.actionWrap}>
                  <Link href="#" className={styles.subscribeTg}>
                    2. Подписаться на канал{' '}
                    <TgIcon className={styles.condIcon} width={26} height={26} />
                  </Link>
                  ...
                  <div data-tooltip-id="unchecked2-tooltip" data-tooltip-content="Подтвердите выполнение" className={styles.unChecked}>
                    <UnCheckedIcon width={23} height={22} />
                  </div>
                  <Tooltip
              ...
              <div className={styles.countdown}>
                ...
                <div className={styles.countText}>
                  Функция станет доступна через <span>09:36</span> мин.
                </div>
              </div>
            ...
            <div className={styles.info}>
              ...
              <PersonageIcon className={styles.personageIcon} />
              <div className={styles.infoText}>
                На данный момент вы можете воспользоваться акцией 1 раз (для 1 аккаунта) - только для проверки сервиса. Повторно станет доступна в праздничные дни или распродажи.
              </div>
