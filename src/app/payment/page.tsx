            ...
            <div className={styles.data}>
                ...
                <div className={styles.dataItem}>
                    ...
                    <div className={styles.mainData}>
                        ...
                        <span className={styles.itemData}>19.02.2024 11:36:12</span>
                    </div>
                    <CopyIcon className={styles.copyIcon} width={17.22} height={17.81}/>
                </div>
                <div className={styles.dataItem}>
            ...
            <div className={styles.revBody}>
                <div className={styles.addRev}>
                    ...
                    <div className={styles.actions}>
                        <button className={styles.btnSubmit}>Добавить отзыв</button>
                        <button className={styles.btnLike}>Рекомендую<LikeIcon width={22.29} height={21.58}/></button>
                        <button className={styles.btnDisLike}>Не Рекомендую<DisLikeIcon width={22.29} height={21.58}/></button>
                    </div>
                </div>
